...
dir.create("plots/AAPL", recursive = TRUE, showWarnings = FALSE)

imagenes <- c("ARIMA_AAPL.png", "MonteCarlo_AAPL.png", "Regression_AAPL.png", "SMA_AAPL.png")

for (img in imagenes) {
  file.copy(paste0("../plots/AAPL/", img), paste0("plots/AAPL/", img), overwrite = TRUE)
  }
```
...
serie_original <- read_csv("../../data/processed/AAPL_full.csv") |>
  rename(real = close) |>
  select(date, real, daily_return, weekly_return, monthly_return, yoy_return)

# Cargar modelos predictivos
model_montecarlo <- readRDS("../../models/MonteCarlo/model_montecarlo_AAPL.rds")
...
ggplot(datos_grafico, aes(x = date)) +
  ...
  labs(
    title = "Comparación de Predicciones de Modelos - AAPL",
    subtitle = paste(
...
knitr::include_graphics("plots/AAPL/ARIMA_AAPL.png")
```
...
knitr::include_graphics("plots/AAPL/MonteCarlo_AAPL.png")
```
...
knitr::include_graphics("plots/AAPL/Regression_AAPL.png")
```
...
knitr::include_graphics("plots/AAPL/SMA_AAPL.png")
```
...
-   `output/tables/AAPL/model_MonteCarlo_metrics.csv`
-   `output/tables/AAPL/model_ARIMA_metrics.csv`
-   `output/tables/AAPL/model_Regression_metrics.csv`
-   `output/tables/AAPL/model_SMA_metrics.csv`
...
#   function(modelo) {
#     archivo <- paste0("output/tables/AAPL/model_", modelo, "_metrics.csv")
